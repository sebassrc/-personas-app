<x-app-layout>
    ...
    <div class="container mx-auto py-6">
        <form method="POST" action="{{ route('municipios.update', ['municipio' => $municipio->muni_codi]) }}">
            ...
            <div class="mb-4">
                <label for="name" class="block text-gray-700 text-sm font-bold mb-2">Municipality Name:</label>
                <input type="text" name="name" id="name" class="form-input rounded-md shadow-sm mt-1 block w-full" value="{{ $municipio->muni_nomb }}" />
            </div>
            <div class="mb-4">
                <label for="department_id" class="block text-gray-700 text-sm font-bold mb-2">Department Code:</label>
